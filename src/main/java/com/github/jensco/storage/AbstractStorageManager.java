...
public abstract class AbstractStorageManager {
    ...
    public abstract void addServer(String guildId, String serverName, String serverAddress, int serverPort, String favicon, String platform);
    ...
    public abstract ServerInfoFromDatabase getServerInfo(String serverName, String guildId);
    ...
    public abstract List<ServerInfoFromDatabase> getAllActiveServers();
